...
<article class="item" id="${resto.id}">
  ...
  <img class="item-picture lazyload" crossorigin="anonymous" data-src="${CONFIG.imageMedium + resto.pictureId}" alt="gambar resto ${resto.name}">
  <div class="detail-item">
    <a href="#/detail/${resto.id}" class="link-item"><h3>${resto.name}</h3></a>
...
<div class="details-container">
    <img crossorigin="anonymous" data-src="${CONFIG.imageLarge + resto.pictureId}" class="detail-img lazyload" alt="${resto.name}">
